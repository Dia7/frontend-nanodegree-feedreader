...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         it('have a defined and not empty - URL', function() {
         ...
         */
        it('have a defined and not empty - name', function() {
            allFeeds.forEach(function (feed) {
    ...
    describe('The menu', function () {
        ...
        /* TODO: Write a test that ensures the menu changes
          ...
          */
        it('changes visability when the icon is clicked', function () {
            var menuHamburger = $('.menu-icon-link');
            // check if menu displays when clicked
            menuHamburger.click();
    ...
    describe('Initial Entries', function () {
        ...
        it('are called and contain at least one feed', function (done){
